...
/**
 * FirewallRuleDetailsResponse Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 */
class FirewallRuleDetailsResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'firewall rule details response';
