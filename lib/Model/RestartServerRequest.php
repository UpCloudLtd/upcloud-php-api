...
/**
 * RestartServerRequest Class Doc Comment
 *
 * @category    Class
 * @package     Upcloud\ApiClient
 */
class RestartServerRequest implements ArrayAccess
{
    ...
    public function setTimeout($timeout)
    {
        ...
        if (!is_null($timeout) && ($timeout > 600)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling RestartServerRequest., must be smaller than or equal to 600.');
        }
        if (!is_null($timeout) && ($timeout < 1)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling RestartServerRequest., must be bigger than or equal to 1.');
        }
