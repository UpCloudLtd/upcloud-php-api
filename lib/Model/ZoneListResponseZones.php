...
/**
 * ZoneListResponseZones Class Doc Comment
 *
 * @category    Class
 * @package     Upcloud\ApiClient
 */
class ZoneListResponseZones implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'zone list response_zones';
    ...
    protected static $swaggerTypes = [
        'zone' => '\Upcloud\ApiClient\Model\Zone[]'
    ];
    ...
    /**
     * Gets zone
     * @return \Upcloud\ApiClient\Model\Zone[]
     */
    ...
    /**
     * Sets zone
     * @param \Upcloud\ApiClient\Model\Zone[] $zone
     * @return $this
     */
