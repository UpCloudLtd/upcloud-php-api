...
/**
 * AttachStorageDeviceRequest Class Doc Comment
 *
 * @category    Class
 * @package     Upcloud\ApiClient
 */
class AttachStorageDeviceRequest implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Attach storage device request';
