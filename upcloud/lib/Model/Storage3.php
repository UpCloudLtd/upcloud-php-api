...
/**
 * Storage3 Class Doc Comment
 *
 * @category    Class
 * @package     Upcloud\ApiClient
 */
class Storage3 implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'storage_3';
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (strlen($title) > 64)) {
            throw new \InvalidArgumentException('invalid length for $title when calling Storage3., must be smaller than or equal to 64.');
        }
