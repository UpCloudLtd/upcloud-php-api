...
/**
 * IpAddress1 Class Doc Comment
 *
 * @category    Class
 * @package     Upcloud\ApiClient
 */
class IpAddress1 implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ip_address_1';
    ...
    {
        $this->container['ptr_record'] = isset($data['ptr_record']) ? $data['ptr_record'] : '';
    }
    ...
    /**
     * Sets ptr_record
     * @param string $ptr_record A fully qualified domain name.
     * @return $this
     */
