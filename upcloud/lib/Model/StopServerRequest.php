...
class StopServerRequest implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'stopServerRequest';
    ...
    public function setTimeout($timeout)
    {
        ...
        if (!is_null($timeout) && ($timeout > 600)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling StopServerRequest., must be smaller than or equal to 600.');
        }
        if (!is_null($timeout) && ($timeout < 1)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling StopServerRequest., must be bigger than or equal to 1.');
        }
